export class Book {
    ...
    set author(author) {
        ...
        if (author.length < 3) {
            throw new Error("Author name should contains more than 2 symbols");
        }
        this._author = author;
    }
    ...
    printInfo() {
        console.log(
            `General info about book "${this._title}" , author is ${this._author} , date of release: ${this._release}`
        );
    }
